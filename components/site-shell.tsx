...
export function Header({ inverse = false }: { inverse?: boolean }) {
  ...
  return <header className={`site-header ${inverse ? 'inverse' : ''}`}>
    <div className="site-shell header-inner">
      <Link href="/" className="brand" onClick={() => setOpen(false)}><span className="brand-logo-stack"><img src="/saaf-trade-mark.png" alt="" className="brand-mark-img" /><img src="/saaf-trade-wordmark.png" alt="Saaf Trade" className="brand-wordmark-img" /></span><span className="brand-text">saaf<span className="brand-dot">.</span>trade</span></Link>
